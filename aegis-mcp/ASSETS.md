# Aegis MCP Consolidated Assets

## Current State

This directory contains the consolidated Aegis MCP offensive security system, merging Strix (planning/generation) and Kit (execution) into a unified nation-state level platform.
...
├── aegis-mcp/               # [TO BE CREATED] Unified MCP server
...
- Unified `aegis` MCP with 25+ tools
