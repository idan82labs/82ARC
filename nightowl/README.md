...
AI-coordinated offensive security platform. Unified MCP interface consolidating autonomous reconnaissance, vulnerability scanning, adaptive payload generation, ephemeral infrastructure management, and AI red teaming.
...
# Build image
docker build -t nightowl:latest .
...
gcloud builds submit --tag gcr.io/PROJECT/nightowl

# Deploy
gcloud run deploy nightowl \
  --image gcr.io/PROJECT/nightowl \
  --platform managed \
  --region us-central1 \
...
register_tool(
    name="nightowl",
    url="https://nightowl-xxx.run.app/mcp",
    introspect=True
)
```
...
By using NIGHTOWL, you agree to:
